...
public class HotelReviewDTO {
	...
	public HotelReviewDTO(int hre_no, int hre_h_no, String hre_m_id, String hre_comment, int hre_score,
			String hre_date) {
		this.hre_no = hre_no;
	...
	public void setHre_coment(String hre_comment) {
		this.hre_comment = hre_comment;
	}
	...
	public String toString() {
		return "HotelReviewDTO [hre_no=" + hre_no + ", hre_h_no=" + hre_h_no + ", hre_m_id=" + hre_m_id
				+ ", hre_comment=" + hre_comment + ", hre_score=" + hre_score + ", hre_date=" + hre_date + "]";
	}
