			...
			<div class="newsletter-form">
				<form action="${path}/member/login_check.do" method="post">
					<input type="text" name="h_name" id="h_name" class="form-control"
						...
						<input
						type="text" name="h_addr" id="roadFullAddr" class="form-control"
						...
						placeholder="가격(1박기준)" autocomplete="off"> <textarea name="h_content" cols="40" rows="8"  style="border:none"placeholder="숙소설명" class="form-control"></textarea>
 					<br>
