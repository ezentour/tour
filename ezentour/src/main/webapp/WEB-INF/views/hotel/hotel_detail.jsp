            ...
            <div class="row">
                <div class="col-12 col-lg-8">
                            ...
                            <div id="room-thumbnail--slide" class="carousel slide" data-ride="carousel">
                                <div class="carousel-inner">
                                    <div class="carousel-item active">
                                        <img src="${path}/resources/img/bg-img/48.jpg" class="d-block w-100" alt="">
                                    </div>
                                    <div class="carousel-item">
                                        <img src="${path}/resources/img/bg-img/49.jpg" class="d-block w-100" alt="">
                                    </div>
                                    <div class="carousel-item">
                                        <img src="${path}/resources/img/bg-img/50.jpg" class="d-block w-100" alt="">
                                    </div>
                                    <div class="carousel-item">
                                        <img src="${path}/resources/img/bg-img/51.jpg" class="d-block w-100" alt="">
                                    </div>
                                    <div class="carousel-item">
                                        <img src="${path}/resources/img/bg-img/52.jpg" class="d-block w-100" alt="">
                                    </div>
                                </div>
                    ...
                    <div class="room-service mb-50">
                        ...
                        <ul>
                            <li><img src="${path}/resources/img/core-img/icon1.png" alt=""> Air Conditioning</li>
                            <li><img src="${path}/resources/img/core-img/icon2.png" alt=""> Free drinks</li>
                            <li><img src="${path}/resources/img/core-img/icon3.png" alt=""> Restaurant quality</li>
                            <li><img src="${path}/resources/img/core-img/icon4.png" alt=""> Cable TV</li>
                            <li><img src="${path}/resources/img/core-img/icon5.png" alt=""> Unlimited Wifi</li>
                            <li><img src="${path}/resources/img/core-img/icon6.png" alt=""> Service 24/24</li>
                        </ul>
                    </div>
