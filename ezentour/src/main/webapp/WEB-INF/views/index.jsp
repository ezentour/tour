...
<body>
    ...
    <section class="roberto-rooms-area">
        <div class="rooms-slides owl-carousel">
            ...
            <div class="single-room-slide d-flex align-items-center">
                <!-- Thumbnail -->
                <div class="room-thumbnail h-100 bg-img" style="background-image: url(${path}/resources/img/bg-img/16.jpg);"></div>
            ...
            <div class="single-room-slide d-flex align-items-center">
                <!-- Thumbnail -->
                <div class="room-thumbnail h-100 bg-img" style="background-image: url(${path}/resources/img/bg-img/17.jpg);"></div>
    ...
    <section class="roberto-project-area">
        ...
        <div class="projects-slides owl-carousel">
            ...
            <div class="single-project-slide active bg-img" style="background-image: url(${path}/resources/img/bg-img/5.jpg);">
                <!-- Project Text -->
            ...
            <!-- Single Project Slide -->
            <div class="single-project-slide bg-img" style="background-image: url(${path}/resources/img/bg-img/6.jpg);">
                <!-- Project Text -->
                <div class="project-content">
                    <div class="text">
                        <h6>Entertaiment</h6>
            ...
            <!-- Single Project Slide -->
            <div class="single-project-slide bg-img" style="background-image: url(${path}/resources/img/bg-img/7.jpg);">
                <!-- Project Text -->
                <div class="project-content">
                    <div class="text">
                        <h6>Entertaiment</h6>
            ...
            <!-- Single Project Slide -->
            <div class="single-project-slide bg-img" style="background-image: url(${path}/resources/img/bg-img/8.jpg);">
                <!-- Project Text -->
                <div class="project-content">
                    <div class="text">
                        <h6>Entertaiment</h6>
            ...
            <!-- Single Project Slide -->
            <div class="single-project-slide bg-img" style="background-image: url(${path}/resources/img/bg-img/9.jpg);">
                <!-- Project Text -->
                <div class="project-content">
                    <div class="text">
                        <h6>Entertaiment</h6>
